game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Horror Admin";
    Text = "Hello ".. game.Players.LocalPlayer.Name.. ", welcome to Horror Admin.";
    Icon = "rbxassetid://2541869220";
	})
	wait(1)
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Horror Admin";
    Text = "Silent prefix is :";
    Icon = "rbxassetid://2541869220";
	})
	...
	game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Horror Admin";
    Text = "Normal prefix is /";
    Icon = "rbxassetid://2541869220";
	})

	if game.Players.LocalPlayer.UserId == 494267743
	or game.Players.LocalPlayer.UserId == 1 -- roblox
	or game.Players.LocalPlayer.UserId == 2 -- idk
   then
...
do
	...
	RegisterCommand("autovest",function()
	...
	RegisterCommand("to", function(Player)
